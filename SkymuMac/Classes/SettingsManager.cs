...
namespace Skymu.Preferences
{
    public static class Settings
    {
        ...
        /// <summary> true = do not inform... do we even need it? TODO: fix </summary>
        ...
        public static bool SavConvListWidth
        {
            get => SELECT("SavConvListWidth", true, "UI/MainWindow");
            set => WRITE("SavConvListWidth", value, nameof(SavConvListWidth), "UI/MainWindow");
        }
